    ...
    <div class="font-[sans-serif] bg-white max-w-4xl flex items-center mx-auto md:h-screen p-4">
        <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
            <div class="max-md:order-1 flex flex-col justify-center space-y-16 max-md:mt-16 min-h-full bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8 px-4 py-4">
                <div>
                    <h4 class="text-white text-lg">Welcome Back</h4>
                    <p class="text-[13px] text-gray-300 mt-3 leading-relaxed">Login to access your account and continue where you left off.</p>
                </div>
                <div>
            ...
            <form action="login.php" method="POST" class="md:col-span-2 w-full py-6 px-6 sm:px-16 max-md:max-w-xl mx-auto">
                <div class="mb-6">
                ...
                <div class="mt-6">
                    <button name="loginSubmit" type="submit" class="w-full py-2.5 px-4 tracking-wider text-sm rounded-md text-white bg-gray-700 hover:bg-gray-800 focus:outline-none">
                        Login
                    </button>
                </div>
                <p class="text-gray-600 text-sm mt-6 text-center">Don't have an account? <a href="signup.html" class="text-blue-600 font-semibold hover:underline ml-1">Sign up here</a></p>
            </form>
        </div>
    </div>
</body>
